...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2016 at 07:59 AM
...
CREATE TABLE IF NOT EXISTS `history_imt` (
...
CREATE TABLE IF NOT EXISTS `history_lemak` (
...
CREATE TABLE IF NOT EXISTS `imt` (
  `ID_IMT` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `presentase_lemak` (
  `ID_LEMAK` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `program_fitness` (
