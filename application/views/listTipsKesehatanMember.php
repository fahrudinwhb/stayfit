  ...
  <div class="row">
    <?php 
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-footer"><?php echo substr(($row->ISI),0,50); ?>...<a href="<?php echo base_url(); ?>index.php/kontrollerListTipsKesehatan/detailTips/<?php echo $row->ID_TIPS; ?>">><br>See More</a></div>
      </div>
    </div>
      <?php
