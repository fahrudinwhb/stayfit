  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="<?php echo base_url(); ?>index.php/c_hitung/lemak/">Hitung Presentase Lemak</a></li>
          <li><a href="<?php echo base_url(); ?>index.php/c_hitung/fitness/">Program Fitness</a></li>
          <li><a href="<?php echo base_url(); ?>index.php/c_datamember/history">History Kesehatan</a></li>
        </ul>
      <ul class="nav navbar-nav navbar-right">
        <li><a href="<?php echo base_url(); ?>index.php/c_user/keluar"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
      </ul>
    </div>
  </div>
</nav>