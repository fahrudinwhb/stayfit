							...
							<table class="table table-striped table-bordered"><!-- table default style -->
								...
								?>
									...
									<td>
										...
										<a href="">
											<img  width="220px" src="<?php echo base_url(); ?>./uploads/<?php echo $row->GAMBAR_TIPS; ?>" alt="">
										<!-- panggil modal -->
									...
									<td border="0">
										<a title="Edit Produk Produk" href="<?php echo base_url(); ?>index.php/kontrollerListTipsKesehatan/getIdTipsKesehatan/<?php echo $row->ID_TIPS; ?>">
											<i class="icon-edit"></i> Edit
										</a> | <a href="#" onClick="if(confirm('Anda yakin HAPUS data ini? ')){document.location='<?php echo base_url()?>index.php/kontrollerListTipsKesehatan/getIdHapusTips/<?php echo $row->ID_TIPS; ?>'}" title="Hapus Produk" >
