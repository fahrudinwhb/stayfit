        ...
        <center>
          ...
          <div class="container"  >
            ...
            <div class="hasil" >
                ...
                <table  border="1px;" width="500px;" style="background-color:grey;" >
            ...
            <a href="<?php echo base_url(); ?>index.php/c_hitung/simpanDataIMT/<?php echo $hasil ?>"><button type="submit" class="btn btn-default" style="margin-top:30px;">Simpan</button></a><br>
            </div>
